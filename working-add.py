...
class Ui_AddProd(QDialog):
    ...
    def insert_prod(self):
        ...
        classification = self.Classi.currentText()
        ...
        with conn:
            ...
            if (idproduct in list_pro):
                ...
                insert_qry = "INSERT INTO product values (\"{0}\", \"{1}\", \"{2}\", \"{3}\", \"{4}\",\"{5}\")".format(idproduct, product_name, description, price, classification, quantity)
    ...
    def setupUi(self, idproduct):
        ...
        self.AddMembah.clicked.connect(self.insert_prod)
